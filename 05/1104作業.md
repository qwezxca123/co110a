...
CHIP CPU {
    ...
    ALU(x=Ddata ,y=ay ,zx=instruction[11] ,nx=instruction[10] ,zy=instruction[9] ,ny=instruction[8] ,f=instruction[7] ,no=instruction[6] ,out=aout ,out=outM ,out[0..7]=tout1,out[8..15]=tout2,out[15]=com); //ALU運算
